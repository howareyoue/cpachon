...
public class MapsNaverActivity extends AppCompatActivity implements OnMapReadyCallback {
    ...
    private static final String CLIENT_ID = "u6nzkkp800"; // Naver Client ID
    private static final String CLIENT_SECRET = "pTQBJXJxzwgiafqynJnFv3kWloFQKTdBUjkFukt1"; // Naver Client Secret
    ...
    private GeocodingService geocodingService; // Geocoding API 서비스
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        geocodingService = retrofit.create(GeocodingService.class); // Geocoding API 호출을 위한 서비스 초기화
    ...
    private void recommendWalkingRoute() {
        ...
        getLatLngFromGeocoding(destination, new GeocodingCallback() {
            @Override
            public void onLatLngReceived(LatLng goalLatLng) {
                if (goalLatLng == null) {
